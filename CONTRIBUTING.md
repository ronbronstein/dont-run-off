...
1. **Agnostic.** No personal names, no specific employers or clients, no one person's workflow. Anything personal belongs in `skills/profile/SKILL.md`, and other skills reference it rather than embedding it. If you can tell whose setup a skill came from, it isn't ready.
...
- Cramming personal preferences into a shared skill instead of `profile`.
